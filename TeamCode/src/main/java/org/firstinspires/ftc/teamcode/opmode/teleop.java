...
//        if(robot.intake.getLeftPixel() && robot.intake.getRightPixel()) CommandScheduler.getInstance().schedule(
//                new SequentialCommandGroup(new stopIntake(), new armToTransferPosition(), new grabLeftPixel(), new grabRightPixel())
//        );
//
...
//        if(robot.deposit.getRollIndex() != 0) robot.deposit.setRollIndex(robot.deposit.getRollIndex()-1);
//        else robot.deposit.setRollIndex(5);
//    }
//
//    public void incrementRollRight(){
//        if(robot.deposit.getRollIndex() != 5) robot.deposit.setRollIndex(robot.deposit.getRollIndex()+1);
//        else robot.deposit.setRollIndex(0);
//    }
//
//    public void decreaseSlideRow(){
//        if(robot.deposit.getSlideTargetRow() != 0) robot.deposit.setSlideTargetRow(robot.deposit.getSlideTargetRow()-1);
