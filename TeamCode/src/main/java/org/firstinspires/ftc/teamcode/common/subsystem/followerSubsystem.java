...
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.headingPIDFSwitch;
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.largeDrivePIDFFeedForward;
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.largeHeadingPIDFFeedForward;
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.largeTranslationalPIDFFeedForward;
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.lateralZeroPowerAcceleration;
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.smallDrivePIDFFeedForward;
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.smallHeadingPIDFFeedForward;
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.smallTranslationalPIDFFeedForward;
//import static org.firstinspires.ftc.teamcode.common.robot.robotConstants.translationalPIDFSwitch;
//
...
//import org.firstinspires.ftc.teamcode.common.pathing.pathGeneration.PathBuilder;
//import org.firstinspires.ftc.teamcode.common.pathing.pathGeneration.PathCallback;
...
//import org.firstinspires.ftc.teamcode.common.pathing.util.DashboardPoseTracker;
//import org.firstinspires.ftc.teamcode.common.pathing.util.Drawing;
//import org.firstinspires.ftc.teamcode.common.pathing.util.PIDFController;
...
// */
//@Config
//public class followerSubsystem extends JSubsystem {
...
//    private double holdPointTranslationalScaling = robotConstants.holdPointTranslationalScaling;
//    private double holdPointHeadingScaling = robotConstants.holdPointHeadingScaling;
...
//
//    private PIDFController smallTranslationalPIDF = new PIDFController(robotConstants.smallTranslationalPIDFCoefficients);
//    private PIDFController smallTranslationalIntegral = new PIDFController(robotConstants.smallTranslationalIntegral);
//    private PIDFController largeTranslationalPIDF = new PIDFController(robotConstants.largeTranslationalPIDFCoefficients);
//    private PIDFController largeTranslationalIntegral = new PIDFController(robotConstants.largeTranslationalIntegral);
//    private PIDFController smallHeadingPIDF = new PIDFController(robotConstants.smallHeadingPIDFCoefficients);
//    private PIDFController largeHeadingPIDF = new PIDFController(robotConstants.largeHeadingPIDFCoefficients);
//    private PIDFController smallDrivePIDF = new PIDFController(robotConstants.smallDrivePIDFCoefficients);
//    private PIDFController largeDrivePIDF = new PIDFController(robotConstants.largeDrivePIDFCoefficients);
//
//
...
//
//
//    public followerSubsystem(boolean setAuto) {
//        setAuto(setAuto);
//        initialize();
//    }
//
...
//     */
//    public Pose getPose() {
//        return robot.poseUpdater.getPose();
//    }
//
//    /**
...
//        robot.poseUpdater.setPose(pose);
//    }
//
//    /**
...
//        return robot.poseUpdater.getVelocity();
//    }
//
//    /**
...
//        return robot.poseUpdater.getAcceleration();
//    }
//
//    /**
...
//        return robot.poseUpdater.getVelocity().getMagnitude();
//    }
//
//    /**
...
//        robot.poseUpdater.setStartingPose(pose);
//    }
//
//    /**
...
//        robot.poseUpdater.setCurrentPoseWithOffset(set);
//    }
//
//    /**
...
//        robot.poseUpdater.setXOffset(xOffset);
//    }
//
//    /**
...
//        robot.poseUpdater.setYOffset(yOffset);
//    }
//
//    /**
...
//        robot.poseUpdater.setHeadingOffset(headingOffset);
//    }
//
//    /**
...
//        return robot.poseUpdater.getXOffset();
//    }
//
//    /**
...
//        return robot.poseUpdater.getYOffset();
//    }
//
//    /**
...
//        return robot.poseUpdater.getHeadingOffset();
//    }
//
//    /**
...
//        closestPose = currentPath.getClosestPoint(robot.poseUpdater.getPose(), 1);
//    }
//
//    /**
//     * This follows a Path.
...
//        followingPathChain = false;
//        currentPath = path;
//        closestPose = currentPath.getClosestPoint(robot.poseUpdater.getPose(), BEZIER_CURVE_BINARY_STEP_LIMIT);
//    }
//
//    /**
//     * This follows a Path.
...
//                closestPose = currentPath.getClosestPoint(robot.poseUpdater.getPose(), 1);
//
//                drivePowers = driveVectorScaler.getDrivePowers(MathFunctions.scalarMultiplyVector(getTranslationalCorrection(), holdPointTranslationalScaling), MathFunctions.scalarMultiplyVector(getHeadingVector(), holdPointHeadingScaling), new Vector(), robot.poseUpdater.getPose().getHeading());
//
//                limitDrivePowers();
//
//            } else {
...
//
//                    drivePowers = driveVectorScaler.getDrivePowers(getCorrectiveVector(), getHeadingVector(), getDriveVector(), robot.poseUpdater.getPose().getHeading());
//
//                    limitDrivePowers();
//
//                }
...
//                        }
//
//                        if ((System.currentTimeMillis() - reachedParametricPathEndTime > currentPath.getPathEndTimeoutConstraint()) || (robot.poseUpdater.getVelocity().getMagnitude() < currentPath.getPathEndVelocityConstraint() && MathFunctions.distance(robot.poseUpdater.getPose(), closestPose) < currentPath.getPathEndTranslationalConstraint() && MathFunctions.getSmallestAngleDifference(robot.poseUpdater.getPose().getHeading(), currentPath.getClosestPointHeadingGoal()) < currentPath.getPathEndHeadingConstraint())) {
...
//            }
//        } else {
//            velocities.add(robot.poseUpdater.getVelocity());
//            velocities.remove(velocities.get(velocities.size() - 1));
//
//            calculateAveragedVelocityAndAcceleration();
//
//            drivePowers = driveVectorScaler.getDrivePowers(teleOpMovementVectors[0], teleOpMovementVectors[1], teleOpMovementVectors[2], robot.poseUpdater.getPose().getHeading());
//
//            limitDrivePowers();
//
//        }
...
//
//        Vector forwardHeadingVector = new Vector(1.0, robot.poseUpdater.getPose().getHeading());
...
//
//        Vector lateralHeadingVector = new Vector(1.0, robot.poseUpdater.getPose().getHeading() - Math.PI / 2);
...
//        headingError = MathFunctions.getTurnDirection(robot.poseUpdater.getPose().getHeading(), currentPath.getClosestPointHeadingGoal()) * MathFunctions.getSmallestAngleDifference(robot.poseUpdater.getPose().getHeading(), currentPath.getClosestPointHeadingGoal());
//        if (Math.abs(headingError) < headingPIDFSwitch) {
//            smallHeadingPIDF.updateError(headingError);
//            headingVector = new Vector(MathFunctions.clamp(smallHeadingPIDF.runPIDF() + smallHeadingPIDFFeedForward * MathFunctions.getTurnDirection(robot.poseUpdater.getPose().getHeading(), currentPath.getClosestPointHeadingGoal()), -1, 1), robot.poseUpdater.getPose().getHeading());
//            return MathFunctions.copyVector(headingVector);
//        }
//        largeHeadingPIDF.updateError(headingError);
//        headingVector = new Vector(MathFunctions.clamp(largeHeadingPIDF.runPIDF() + largeHeadingPIDFFeedForward * MathFunctions.getTurnDirection(robot.poseUpdater.getPose().getHeading(), currentPath.getClosestPointHeadingGoal()), -1, 1), robot.poseUpdater.getPose().getHeading());
//        return MathFunctions.copyVector(headingVector);
//    }
//
//    /**
...
//        double x = closestPose.getX() - robot.poseUpdater.getPose().getX();
//        double y = closestPose.getY() - robot.poseUpdater.getPose().getY();
...
//        }
//
//        if (MathFunctions.distance(robot.poseUpdater.getPose(), closestPose) < translationalPIDFSwitch) {
...
//        centripetalVector = new Vector(MathFunctions.clamp(robotConstants.centripetalScaling * robotConstants.mass * Math.pow(MathFunctions.dotProduct(robot.poseUpdater.getVelocity(), MathFunctions.normalizeVector(currentPath.getClosestPointTangentVector())), 2) * curvature, -1, 1), currentPath.getClosestPointTangentVector().getTheta() + Math.PI / 2 * MathFunctions.getSign(currentPath.getClosestPointNormalVector().getTheta()));
...
//        telemetry.addData("total heading", robot.poseUpdater.getTotalHeading());
...
//        return robot.poseUpdater.getTotalHeading();
//    }
//
//    /**
