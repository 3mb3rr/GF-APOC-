...
@Autonomous
public class oldAutoRedFar extends CommandOpMode {
        ...
        while (opModeInInit()) {
            ...
            CommandScheduler.getInstance().schedule(
                    new SequentialCommandGroup(
                            new followPath(toSpikeMiddle),  //CenterstageConstants.getPath(zone, toSpikeLeft,toSpikeMiddle,toSpikeRight)
...
//                            new WaitCommand(500),
                            new WaitCommand(100),
                            new followPath(toBackboardMiddle), //CenterstageConstants.getPath(zone,toBackboardLeft,toBackboardMiddle,toBackboardRight)
                            new WaitUntilCommand(busy),
//                            new WaitCommand(200),
//                            new releaseLeftPixel(),
//                            new releaseRightPixel(),
